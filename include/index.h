	  ...
	  <div class="content">
	    <div id="myCard" class="card">
	      <!-- <p class="state">state: <span id="state">%STATE%</span></p> -->
	       ...
	       <p><button onclick="myFunction(1)" id="button1" class="button button1"> </p><p><i class="fa fa-thermometer-half"></i> Kúrenie</button></p> 
		     <p><button onclick="myFunction(2)" id="button1" class="button button1"> </p><p><i class="fa fa-cloud-sun"></i> Žalúzie</button></p> 
	     	 <p><button onclick="myFunction(3)" id="button1" class="button button1"> </p><p><i class="fa fa-lightbulb"></i> Svetlá</button></p> 
		     <p><button onclick="myFunction(100)" class="button button1"> </p><p><i class="fa fa-cogs"></i> Nastavenie</button></p> 
...
function myFunction(rt) 
 {
	  ...
	  <div class="content">
	    <div id="myCard" class="card">
	      <!-- <p class="state">state: <span id="state">%STATE%</span></p> -->
	        <p><button onclick="myFunction(1)" id="button0" class="button button1">Garáž</p><p><i class="fa fa-thermometer-half"></i> <span id="tep1">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum1">--.-</span>%</button></p> 
 		      <p><button onclick="myFunction(2)" id="button1" class="button button1">Detská Timea</p><p><i class="fa fa-thermometer-half"></i> <span id="tep2">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum2">--.-</span>%</button></p> 
	        <p><button onclick="myFunction(3)" id="button2" class="button button1">Zádverie</p><p><i class="fa fa-thermometer-half"></i> <span id="tep3">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum3">--.-</span>%</button></p> 
		      <p><button onclick="myFunction(4)" id="button3" class="button button1">Jedáleň</p><p><i class="fa fa-thermometer-half"></i> <span id="tep4">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum4">--.-</span>%</button></p> 
	        <p><button onclick="myFunction(5)" id="button4" class="button button1">Kuchyň</p><p><i class="fa fa-thermometer-half"></i> <span id="tep5">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum5">--.-</span>%</button></p> 
		      <p><button onclick="myFunction(6)" id="button5" class="button button1">Obývacia miestnosť</p><p><i class="fa fa-thermometer-half"></i> <span id="tep6">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum6">--.-</span>%</button></p> 
	        <p><button onclick="myFunction(7)" id="button6" class="button button1">Chodba</p><p><i class="fa fa-thermometer-half"></i> <span id="tep7">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum7">--.-</span>%</button></p> 
 		      <p><button onclick="myFunction(8)" id="button7" class="button button1">Detská Filip</p><p><i class="fa fa-thermometer-half"></i> <span id="tep8">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum8">--.-</span>%</button></p> 
	        <p><button onclick="myFunction(9)" id="button8" class="button button1">Spálňa</p><p><i class="fa fa-thermometer-half"></i> <span id="tep9">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum9">--.-</span>%</button></p> 
		      <p><button onclick="myFunction(10)" id="button9" class="button button1">Kúpeľňa</p><p><i class="fa fa-thermometer-half"></i> <span id="tep10">--.-</span>&deg;C &nbsp;<i class="fa fa-tint"></i> <span id="hum10">--.-</span>%</button></p> 
...
function myFunction(rt) 
 {
	  ...
	  <div class="content">
	    <div id="myCard" class="card">
	        <p><button onclick="myFunction(1)" id="button1" class="button button_stin fa fa-arrow-alt-circle-up"> otvoriť všetky žaluzie</button></p> 
	        <p><button onclick="myFunction(2)" id="button2" class="button button_stin fa fa-arrow-alt-circle-down	"> zatvoriť všetky žaluzie</button></p> 
...
<body>
 ...
 <div class="content">
  	...
  	<div id="Text2" style="position:absolute;left:100px;top:220px;width:312px;height:30px;">
		<span style="font-size:30px;">Teplota (&deg;C) cez časový harmonogram</span></div>
		<div id="Text3" style="position:absolute;left:570px;top:220px;width:315px;height:30px;">
		<span style="font-size:30px;" >Teplota (&deg;C) mino časový harmonogram</span></div>
   ...
   <input type="time" id="Editbox8" class="Timebox" style="position:absolute;left:510px;top:130px;" Value="01:12" >
 	 ...
 	 <input type="number" id="Editbox01" class="tBox_temp" style="position:absolute;left:315px;top:320px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox02" class="tBox_temp" style="position:absolute;left:315px;top:400px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox03" class="tBox_temp" style="position:absolute;left:315px;top:480px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox04" class="tBox_temp" style="position:absolute;left:315px;top:560px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox05" class="tBox_temp" style="position:absolute;left:315px;top:640px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox06" class="tBox_temp" style="position:absolute;left:315px;top:720px;"  value=11.2 min="10" max="30" step="0.1" > 
	 <input type="number" id="Editbox07" class="tBox_temp" style="position:absolute;left:315px;top:800px;"  value=11.2 min="10" max="30" step="0.1" > 
   ...
   <div style="position:absolute;left:80px;top:200px; border-left: 800px solid #143642;height: 4px;"></div>
	 ...
	 <input type="number" id="Editbox08" class="tBox_temp" style="position:absolute;left:550px;top:320px;"  value=11.2 min="10" max="30" step="0.1" > 
	 <input type="number" id="Editbox09" class="tBox_temp" style="position:absolute;left:550px;top:400px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox10" class="tBox_temp" style="position:absolute;left:550px;top:480px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox11" class="tBox_temp" style="position:absolute;left:550px;top:560px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox12" class="tBox_temp" style="position:absolute;left:550px;top:640px;"  value=11.2 min="10" max="30" step="0.1" > 
 	 <input type="number" id="Editbox13" class="tBox_temp" style="position:absolute;left:550px;top:720px;"  value=11.2 min="10" max="30" step="0.1" > 
	 <input type="number" id="Editbox14" class="tBox_temp" style="position:absolute;left:550px;top:800px;"  value=11.2 min="10" max="30" step="0.1" > 
	 
	 <div id="Tx11" style="position:absolute;left:50px;top:920px;">
		<span style="font-size:25px;" >Názov miestnosti (max 25 znakov):</span></div>
	 <input type="text" id="tB_nazovMiesti" style="font-size:40px; position:absolute;left:50px;top:950px;width:600px;height:70px;" value="{{LEDIO}}" maxlength="25"> 
	 
	 <p><button onclick="myFunction(1)" class="button button1" id="param1" style="position:absolute;left:50px;top:1100px;" >Uložiť nastavenie</button></p> 
	 <p><button onclick="myFunction(2)" class="button button1" id="param2" style="position:absolute;left:50px;top:1300px;" >Návrat zpět na vytápění</button></p> 
   <i  id="spinerek" class="fa fa-spinner fa-spin" style="display:none; position:absolute;left:320px;top:600px;width:300px;height:400px; font-size:200px;"></i>
